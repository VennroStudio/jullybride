...
<div class="jb-cart">
    <form class="woocommerce-cart-form jb-cart__form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
        <?php do_action('woocommerce_before_cart_table'); ?>

        <div class="jb-cart__table-wrap">
            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents jb-cart__table" cellspacing="0">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" class="actions">
                            <div class="jb-cart__actions">
                                <?php if (wc_coupons_enabled()) : ?>
                                    <div class="coupon jb-cart__coupon">
    ...
    <div class="cart-collaterals jb-cart__collaterals">
